...
(function (e) {
  function m(d, b, h, c, a) {
        ...
        return (
          "list" == a.layoutMode
            ? (c.addClass(a.listClass),
              ...
              l.css("display", a.targetDisplayList))
            : (c.addClass(a.gridClass),
              c.removeClass(a.listClass),
    ...
    if (q.length) {
      ...
      "block" == a.origDisplay
        ? (c.addClass(a.listClass), p.css("display", a.targetDisplayList))
      ...
      "list" == a.layoutMode
        ? (c.addClass(a.listClass), c.removeClass(a.gridClass))
        ...
        k.bind(
          ...
          function (a) {
            if (
              ...
              -1 < r.indexOf(".")
                ? e(a.target).hasClass(r.replace(".", "")) && j()
                : e(a.target).is(r) && j();
          }
        );
      }, 10);
  ...
  function v(d, b, h, c) {
    function a(a, b) {
      return 1 * a.attr(d).toLowerCase() < 1 * b.attr(d).toLowerCase()
        ? -1
        : 1 * a.attr(d).toLowerCase() > 1 * b.attr(d).toLowerCase()
        ? 1
        : 0;
    }
    function j(a) {
	...
	"
      ...
      "custom" == d
        ...
        : ("undefined" === typeof c.origOrder[0].attr(d) &&
  ...
  var w = {
    init: function (d) {
      return this.each(function () {
        ...
        "list" == b.layoutMode
          ? (h.addClass(b.listClass), (b.origDisplay = b.targetDisplayList))
          : (h.addClass(b.gridClass), (b.origDisplay = b.targetDisplayGrid));
    ...
    toGrid: function () {
      return this.each(function () {
        var d = this.config;
        "grid" != d.layoutMode &&
          ((d.layoutMode = "grid"), m(d.filter, null, null, e(this), d));
      });
    },
    toList: function () {
      return this.each(function () {
        var d = this.config;
        "list" != d.layoutMode &&
          ((d.layoutMode = "list"), m(d.filter, null, null, e(this), d));
      });
    },
    filter: function (d) {
      return this.each(function () {
  ...
  Array.prototype.compare = function (d) {
    ...
    for (var b = 0; b < d.length; b++)
      if ((this[b].compare && !this[b].compare(d[b])) || this[b] !== d[b])
        return !1;
    return !0;
  };
})(jQuery);
